...
//login
val AestheticBlue = Color(0xFF396EBE) // fondo centro
val AestheticBlueLight = Color(0xFFB3D4FF) // fondo superior
val AestheticWhite = Color(0xFFB4D9EE) // fondo inferior
...
val PrimaryPinkLight = Color(0xFF4C6ADE) //boton crear cuenta
val PrimaryPink = Color(0xFFc073cd)
val PrimaryPinkDark = Color(0xFF1518B6) //boton acceder

val PrimaryVioletLight = Color(0xFF9787DE)
